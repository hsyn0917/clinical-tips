...
1. **まずCTCAE gradeを決める**
2. **胸部CTを放射線dose mapと比較する**
3. **RP優位 / ICI-pneumonitis優位 / 判別困難**に分類する
4. 判別困難で症候性なら、原則として **durvalumab休薬＋ICI-pneumonitisに準じた対応**
5. G2 ICI-pneumonitisでは **PSL 1–2 mg/kg/day**を開始し、48–72時間で反応を評価
6. 改善後は **6週間以上**かけて漸減
7. durvalumab再開は、少なくとも **症状消失＋PSL ≤10 mg/day**を基本条件とする
8. G3後の再開は例外的、G4後は再開しない
9. 再投与後に症候性肺臓炎が再燃した場合は **永久中止**

---

## PACIFIC試験プロトコルでの肺臓炎対応

PACIFIC試験のprotocol supplementには、**original Clinical Study ProtocolのTable 5**と、その後のより詳細な**Appendix H toxicity-management guideline**が含まれており、肺臓炎の再開基準に若干の差がある。

### Original PACIFIC protocol（Table 5）

| Grade | durvalumab | 再開・中止基準 |
|---|---|---|
| **G1** | 継続 | dose modificationなし |
| **G2** | **休薬** | G≤1まで改善した場合に再開を検討。ただし、最大支持療法（ステロイドを含む）開始後 **3日以内にG≤1へ改善した場合のみ次回予定投与から再開**。それ以外は中止 |
| **G3** | **中止** | pneumonitisでは再開しない |
| **G4** | **中止** | 再開しない |

PACIFIC original protocolでは、G2 pneumonitisの再開条件は現在の実臨床よりかなり厳格であった。

### PACIFIC Appendix H

より後期のAppendix Hでは、肺臓炎/ILDについて以下のように整理されている。
...
- 最終投与後12週間以内に corticosteroidを **prednisone ≤10 mg/day相当**まで減量できない
- 再投与後に、以前経験した **Grade 3 treatment-related AEが再発**
...
1. Brade AM, Bahig H, Bezjak A, et al. Esophagitis and Pneumonitis Related to Concurrent Chemoradiation ± Durvalumab Consolidation in Unresectable Stage III Non-Small-Cell Lung Cancer: Risk Assessment and Management Recommendations Based on a Modified Delphi Process. *Current Oncology*. 2024;31(11):6512-6535.  
   https://doi.org/10.3390/curroncol31110483
...
3. PACIFIC Clinical Study Protocol / Appendix H. Study code D4191C00001. MEDI4736 (durvalumab).

4. Käsmann L, et al. Diagnosis and management of pneumonitis following chemoradiotherapy and immunotherapy in stage III non-small cell lung cancer. *Radiother Oncol*. 2024;194:110147.  
   https://doi.org/10.1016/j.radonc.2024.110147
