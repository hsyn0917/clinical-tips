...
![レスキュー製剤の種類](assets/opioid_p42.png)
...
![痛みと眠気によるオピオイド投与量の評価](assets/opioid_p48.png)
...
下記をコピー＆ペーストして指示にご活用ください。

開始速度、ベースアップ間隔、レスキュー量については、文章内容を確認し、選択・修正のうえで指示してください。

### 指示

**これは皮下注用の指示です**

モルヒネ塩酸塩注 5 mL（50 mg）＋生食 5 mL／合計 10 mL

!!! warning "注意"
    モルヒネ 5 mg/mL。投与速度上限は 0.4 mL/時。

- 投与デバイス：小型シリンジポンプ 10 mL 使用
- **0.1 mL/時（モルヒネ 12 mg/日）から開始**
- **高齢者や全身状態が不良な場合には 0.05 mL/時（モルヒネ 6 mg/日）から開始**
- **ベースアップ**：意識清明・RR 10回/分以上を確認して、8時間ごとに1段階ずつ増量可
- **眠気が強い時**：1〜2段階減量可
  - 0.05 mL/時（モルヒネ 6 mg/日）
  - 0.1 mL/時（モルヒネ 12 mg/日）
  - 0.15 mL/時（モルヒネ 18 mg/日）
  - 0.2 mL/時（モルヒネ 24 mg/日）
  - 0.3 mL/時（モルヒネ 36 mg/日）
  - 0.4 mL/時（モルヒネ 48 mg/日）
- **疼痛時頓用**：1時間分早送り。効果がないときは2時間分にしてもよい。RR 10回/分以上なら30分あけて反復可
